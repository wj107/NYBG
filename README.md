...
raw data is available in a text file -- not ideal for analysis.  Running this little R script in your directory where the database text file 
("occurence.txt") is located allows you to input the data directly into R as a data frame.

### The data

The text file with the raw database information can be downloaded from the
[Global Biodiversity Information Facility (GBIF)](https://www.gbif.org/dataset/d415c253-4d61-4459-9d25-4015b9084fb0)  You need this data first!
